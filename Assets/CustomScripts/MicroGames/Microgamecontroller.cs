...
namespace InterDineMension.MicroGame
{
    ...
    public class Microgamecontroller : MonoBehaviour
    {
        ...
        {
            bAM.pC.playerMovment.value = 50;
            dM.ExitDialogueMode(false, 0,"StartBAM",false);
        ...
        {
            bAM.pC.playerMovment.value = 50;
            dM.ExitDialogueMode(false, 0,"StartBAMLvl2",false);
            bAMContainer.SetActive(true);
        ...
        {
            bAM.pC.playerMovment.value = 50;
            dM.ExitDialogueMode(false, 0,"StartBAMLvl3",false);
            bAMContainer.SetActive(true);
